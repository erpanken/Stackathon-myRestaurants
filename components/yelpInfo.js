      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.getStartedContainer}>
            {image ? null : (
              <Text style={styles.getStartedText}>Emmy's App</Text>
            )}
          </View>
...
submitToYelp = async () => {
  try {
    ...
    // console.log(responseJson);
    this.setState({
      yelpResponse: yelpResponseJson,
    });
    console.log(yelpResponseJson);
  } catch (error) {
    console.log(error);
  }
};
...
// const displayAddress = yelpResponseJson.businesses[0].location.display_address
// yelpResponse Object {
//     "businesses": Array [
//       Object {
//         "alias": "jacks-wife-freda-new-york-2",
//         "coordinates": Object {
//           "latitude": 40.7300978230111,
//           "longitude": -74.0031156668122,
//         },
//         "display_phone": "(646) 669-9888",
//         "id": "HrdIdeDZBTUdyEdSTPG1zg",
//         "location": Object {
